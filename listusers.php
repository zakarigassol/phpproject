...
$query = "select u.*, m.Plans from users u, memberplans m where m.id = u.Plan";
...
mysqli_stmt_bind_result($stmt, $username, $password, $name, $surname, $dob, $email, $gender, $phone, $plan, $planName) or exit('Result storage failed.' . mysqli_stmt_errno($stmt));;



echo '<table border="1"><tr><th>usernames</th><th>passwords</th><th>names</th><th>surnames</th><th>dob</th><th>emails</th><th>gender</th><th>phones</th><th>Plan</th><th>delete</th></tr>';



while (mysqli_stmt_fetch($stmt)) {
  // $q = "Select * from memberplans where id = $plan";
  ...
  echo "<td><a style='color:black'  href='./deleteuserplan.php?username=" . $username . "'>delete membership plan</a></td>";
  echo '</tr>';
}
